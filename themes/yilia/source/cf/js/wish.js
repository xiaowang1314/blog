...
(function($){
	$.fn.wish = function() {
		...
		_wish.each(function(i){
			...
			_self.hover(
				function(){
					_self.css({'z-index':'9999','border':'none'}).children('.close').show().bind('click',function(){_self.effect('scale',{percent: 0},200,function(){_self.remove()})});
				},
				function(){
